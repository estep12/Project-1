...
$('#food-btn').on("click", function foodWidget(){
    ...
    let newSrc ="https://www.zomato.com/widgets/res_search_widget.php?lat=" + latitudeFood + "&lon=" + longitudeFood + "&theme=black&hideCitySearch=on&hideResSearch=on&sort=rating"
